...
const STAT_CARDS: { key: keyof DashboardStats; label: string }[] = [
  ...
  { key: "totalTransportRequired", label: "Transporte da organização" },
  { key: "totalTaxi", label: "Vão de táxi" },
  { key: "totalOwnCar", label: "Vão de carro próprio" },
  ...
  { key: "totalMissingBelongings", label: "Saídas com pertences em falta" },
