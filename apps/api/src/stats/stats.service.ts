...
export class StatsService {
  ...
  async dashboard(userId: string) {
    const [
      ...
      this.prisma.participant.count({ where: { ...NOT_DELETED, checkedIn: true, insideVenue: false } }),
      this.prisma.movementLog.count({ where: { type: 'EXIT', belongingsOk: false } }),
